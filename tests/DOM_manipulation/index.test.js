...
test("check if rendercoffee renders coffee", () => {
  ...
  expect(renderCoffee(c)).toBe(
    `<div class=\"coffee\"><div class=flex><div class=\"d-none\">1</div><div class=\"name\"><p>coffees</p></div><p class=\"roast\">light</p></div><div class=\"del\">X</div></div>`
  );
});
...
test("check if updates coffee updates coffee", () => {
  ...
  expect(coffeeList.innerHTML).toBe(
    '<div class="coffee"><div class="flex"><div class="d-none">2</div><div class="name"><p>Half City</p></div><p class="roast">light</p></div><div class="del">X</div></div>'
  );
});
